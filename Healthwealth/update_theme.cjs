...
const decorativeBgs = `
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[800px] h-[800px] bg-violet-400/20 blur-[120px] rounded-full pointer-events-none mix-blend-multiply z-0"></div>
      <div className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] bg-sky-400/20 blur-[100px] rounded-full pointer-events-none mix-blend-multiply z-0"></div>
      <div className="absolute top-[20%] right-[10%] w-[400px] h-[400px] bg-emerald-400/10 blur-[90px] rounded-full pointer-events-none mix-blend-multiply z-0"></div>
`;
